            ...
            <div class="card-body">
                ...
                <form class="form-horizontal p-t-20" action="{{route('brand.update',['id' => $brand->id])}}" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="form-group row">
                        <label for="exampleInputuname3" class="col-sm-3 control-label">Edit Brand</label>
                        {{-- <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" name="name" value="{{$brand->name}}" id="exampleInputEmail3" placeholder="Brand Name">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <level class="me-3"> <input type="radio" name="status" {{$brand->status == 1 ? 'checked' : ''}} value="1" checked> Published </level>
                                <level> <input type="radio" name="status" {{$brand->status == 2 ? 'checked' : ''}} value="2"> Un-Published </level>
