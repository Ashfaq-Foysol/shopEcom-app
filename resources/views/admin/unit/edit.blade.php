            ...
            <div class="card-body">
                ...
                <form class="form-horizontal p-t-20" action="{{route('unit.update',['id'=>$unit->id])}}" method="POST" >
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" class="form-control" name="name" value="{{$unit->name}}" id="exampleInputEmail3" placeholder="Unit Name">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                <input type="text" name="code" value="{{$unit->code}}" class="form-control" id="" placeholder="code">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group">
                                ...
                                <level> <input type="radio" name="status" {{$unit->status == 2 ? 'checked' : ''}} value="2"> Un-Published </level>
